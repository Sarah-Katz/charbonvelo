...
class ModeratorController extends AbstractController
{
    ...
    {
        if (!$this->canEdit($message)) { return $this->redirectMessage($message); }
    ...
    private function redirectMessage(Message $message) : Response
    {
    ...
    // We check if the user is the author of the message
    private function canEdit(Message $message): bool  {
        $isAuthor = $message->getAuthor()->getId() == $this->getUser()->getId();
